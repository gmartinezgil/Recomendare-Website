...
public abstract class SignInPanel extends Panel {
	...
	//the window in case of use in a window of this panel...instead of a page...
	...
	public final class SignInForm extends Form {
		...
		public SignInForm(final String id) {
			...
			add(new Label("usernameLabel", new LabelStringDetachableModel("USERNAME")));
			// Attach text field components that edit properties map
			...
			add(password = new PasswordTextField("password", new PropertyModel(properties, "password")) {
				...
				protected boolean supportsPersistence() {
			        return true;//TODO:here also for 
			    }
			});
			...
			rememberMeRow.add(new Label("remembermeLabel", new LabelStringDetachableModel("REMEMBERME_IN_THIS_COMPUTER")));
			...
			if(modalWindow == null)  {
				final Button logInButton = new Button("logInButton", new LabelStringDetachableModel("SIGNIN")){
					private static final long serialVersionUID = 1L;
					public void onSubmit() {
						if (signIn(getUsername(), getPassword())) {
							...
							error(new LabelStringDetachableModel("ERROR_UNABLE_TO_LOGIN_YOU"));
						}
					}
				};
				add(logInButton);
				...
				final AjaxFallbackButton loginButton = new AjaxFallbackButton("logInButton", new LabelStringDetachableModel("SIGNIN"), this){
					private static final long serialVersionUID = 1L;
				...
				add(loginButton);
				final AjaxFallbackButton cancelButton = new AjaxFallbackButton("cancelButton", new LabelStringDetachableModel("CANCEL"), this){
					private static final long serialVersionUID = 1L;
					protected void onSubmit(AjaxRequestTarget target, Form form) {
						modalWindow.close(target);
					}
	...
	public SignInPanel(final String id, final ModalWindow modalWindow, final boolean includeRememberMe)  {
		super(id);
		this.includeRememberMe = includeRememberMe;
	...
	public void setPersistent(boolean enable) {
		...
		password.setPersistent(enable);//TODO:here we remove them...
	}
